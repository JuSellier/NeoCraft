...
const P5sketch = ({sketchData, setupFunc, drawFunc, title = "P5sketch", description, titleHidden = false, autoPlay = false, controlsHidden = false, noBorder = false}) => {
  ...
  return (
    ...
    <div className="P5sketch-wrapper" style={{boxShadow: `0 0 0 1px ${(!noBorder && playing) ? "var(--clr-txt)" : "transparent"}`}}>
      {loading ?
